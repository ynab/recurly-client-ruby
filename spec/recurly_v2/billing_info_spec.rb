...
XML
  ...
  describe 'verify' do
    it 'verifies billing info' do
      ...
      verified.must_be_instance_of RecurlyV2::Transaction
    ...
    it 'sends specified gateway code' do
      ...
      RecurlyV2::Verify.to_xml(gateway).must_equal "<verify><gateway_code>gateway_code</gateway_code></verify>"
      verified.must_be_instance_of RecurlyV2::Transaction
      verified.origin.must_equal "api_verify_card"
    end
  ...
  describe 'verify_cvv' do
    it 'verifies the cvv' do
      ...
      verified.must_be_instance_of RecurlyV2::BillingInfo
    end
    ...
    it 'sends the verification value' do
      ...
      RecurlyV2::BillingInfo.to_xml(attrs).must_equal "<billing_info><verification_value>876</verification_value></billing_info>"
    end
  end
