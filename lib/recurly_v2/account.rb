module RecurlyV2
  # Accounts are core to managing your customers inside of RecurlyV2.
  # The account object stores the entire RecurlyV2 history of your customer and acts as the entry point
  # for working with a customer's billing information, subscription data, transactions, invoices and more.
  #
  # RecurlyV2 Documentation: https://dev.recurly.com/docs/account-object
  class Account < Resource
    ...
    def get_billing_infos
      Pager.new(RecurlyV2::BillingInfo, uri: "#{path}/billing_infos", parent: self)
    rescue RecurlyV2::API::UnprocessableEntity => e
      raise Invalid, e.message
    end
    ...
    # @raise [RecurlyV2::Transaction::Error] A Transaction Error will be raised if the gateway declines
    # the cvv code.
