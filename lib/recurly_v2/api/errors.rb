  ...
  class API
    ...
    class ResponseError < Error
      ...
      def xml
        ...
        rescue RecurlyV2::XML::ParseError
          nil
        end
      end
    end
    ...
    #
    # Your RecurlyV2 account is in production mode but is not in good standing.
    ...
    # === 502 Gateway Error
    #
    # The load balancer or web server had trouble connecting to the RecurlyV2.
