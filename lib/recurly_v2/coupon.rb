module RecurlyV2
  ...
  # RecurlyV2 Documentation: https://dev.recurly.com/docs/list-active-coupons
  class Coupon < Resource
    ...
    def redeem account_or_code, currency = nil, extra_opts={}
      ...
      redemption_options = {
        ...
        :currency     => currency || RecurlyV2.default_currency
      }.merge(extra_opts)
    ...
    def generate(amount)
      ...
      Pager.new(RecurlyV2::Coupon, uri: resp['location'], parent: self, etag: resp['ETag'])
    end
