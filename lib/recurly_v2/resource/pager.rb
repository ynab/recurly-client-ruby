...
module RecurlyV2
  class Resource
    ...
    #     state: :collected
    #   }
    #   invoices = RecurlyV2::Invoice.paginate(opts)
    #   begin
    ...
    #     state: :collected
    #   }
    #   RecurlyV2::Invoice.find_each(opts) do |invoice|
    #     puts invoice
    #   end
    #
    class Pager
      ...
      #     state: :collected
      #   }
      #   count = RecurlyV2::Invoice.paginate(opts).count
      #   #=> 42
      #
      ...
      #   ISO 8601 date or date and time.
      # @example
      #   RecurlyV2::Account.paginate(sort: :updated_at, per_page: 20)
      ...
      # @example
      #   account = RecurlyV2::Account.find 'schrader'
