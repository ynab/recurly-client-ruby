module RecurlyV2
  class Transaction < Resource
    require 'recurly_v2/transaction/errors'
    ...
    #
    # @return [true, false]
    # @raise [RecurlyV2::Error] For persisted transactions.
    # @see Resource#save
    def save
      return super if new_record?
      raise RecurlyV2::Error, "#{self.class.collection_name} cannot be updated"
    end
