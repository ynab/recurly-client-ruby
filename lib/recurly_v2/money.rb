module RecurlyV2
  ...
  class Money
    ...
    #   RecurlyV2::Money.new :USD => 12_00
    #
    #   # $9.99 (or €6.99).
    #   RecurlyV2::Money.new :USD => 9_99, :EUR => 6_99
    #
    #   # Using a default currency.
    #   RecurlyV2.default_currency = 'USD'
    #   RecurlyV2::Money.new(49_00) # => #<RecurlyV2::Money USD: 49_00>
    def initialize currencies = {}, parent = nil, attribute = nil
      ...
      elsif RecurlyV2.default_currency
        self[RecurlyV2.default_currency] = currencies
      else
        message = 'expected a Hash'
        message << ' or Numeric' if RecurlyV2.default_currency
    ...
    # @param other [Money]
    # @example
    #   [RecurlyV2::Money.new(2_00), RecurlyV2::Money.new(1_00)].sort
    #   # => [#<RecurlyV2::Money USD: 1_00>, #<RecurlyV2::Money USD: 2_00>]
    # @see Hash#<=>
    def <=> other
    ...
    def method_missing name, *args, &block
      ...
      elsif c = currencies[RecurlyV2.default_currency] and c.respond_to? name
