module RecurlyV2
  class Subscription < Resource
    require 'recurly_v2/subscription/add_ons'
    ...
    #   returned by RecurlyV2.js referencing the result of the 3DS authentication for PSD2
    ...
    def convert_trial(three_d_secure_action_result_token_id = nil)
      body = if three_d_secure_action_result_token_id != nil
        builder = RecurlyV2::XML.new("<subscription/>")
