module RecurlyV2
  # The history of your customer's RecurlyV2 account can be tracked through adjustments, made up of credits and charges.
  #
  # RecurlyV2 Documentation: https://dev.recurly.com/docs/adjustment-object
  class Adjustment < Resource
    ...
    def initialize(attributes = {})
      super({ :currency => RecurlyV2.default_currency }.merge attributes)
    end
